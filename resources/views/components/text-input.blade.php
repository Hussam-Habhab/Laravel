<div class="relative">
    ...
    @if($formRef)
    <button type="button" class="absolute top-0 right-0 h-full" 
  @click="$refs['input-{{$name}}'].value = '';$refs['{{ $formRef }}'].submit()"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
